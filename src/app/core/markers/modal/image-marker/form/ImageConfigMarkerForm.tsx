...
import {ConfigMarkerProps} from "../ImageMarkerConfig";
...
const ImageConfigMarkerForm: FC<ConfigMarkerFormProps> = ({register, setValue}) => {
...
export default ImageConfigMarkerForm;